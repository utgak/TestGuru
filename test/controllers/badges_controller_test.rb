...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { condition: @badge.condition, img: @badge.img, option: @badge.option, title: @badge.title } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { condition: @badge.condition, img: @badge.img, option: @badge.option, title: @badge.title } }
